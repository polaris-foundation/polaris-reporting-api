...
K8S_DHOS_URL_API_NAMESPACES=dhos-reporting-api
...
helm upgrade --install --namespace ${K8S_DHOS_URL_API_NAMESPACES} dhos-reporting-api $(dirname ${BASH_SOURCE})/helm-chart/dhos-reporting-api \
     -f $(dirname ${BASH_SOURCE})/helm-chart/dhos-reporting-api/values.yaml \
     -f $(dirname ${BASH_SOURCE})/helm-chart/dhos-reporting-api/values-az-uk-prod006.yaml \
     -f <(sops --decrypt $(dirname ${BASH_SOURCE})/helm-chart/dhos-reporting-api/values-az-uk-prod006-secrets-sops.yaml)
